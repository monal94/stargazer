...
| ○ | [vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser) | Browser automation CLI for AI agents | Rust | 29.2k | agents, ai, browser-automation, cli | Browser automation CLI for AI agents by Vercel |
